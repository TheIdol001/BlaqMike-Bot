#!/usr/bin/env python3
"""
IQ Option Telegram Bot v3 - Full Button-Based Experience (Render Fixed)
"""
...
# ====================== FIX FOR RENDER ======================
# This fixes the "no current event loop" error on Render + Python 3.14
...
def main():
    ...
    print("✅ IQ Option Bot v3 is running...")
    app.run_polling()
