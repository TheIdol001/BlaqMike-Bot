#!/usr/bin/env python3
"""
IQ Option Telegram Bot v3 - Final Version (Fixed)
- Button-based flow
- Fixed password handling
- Event loop fix + Dummy port for Render free tier
"""
...
# ==================== SINGLE TEXT HANDLER (Email + Password) ====================
...
def main():
    ...
    # Single text handler for email + password
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_text))

    print("✅ IQ Option Bot v3 Final is running...")
    app.run_polling()
