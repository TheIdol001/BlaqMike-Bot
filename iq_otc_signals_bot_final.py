#!/usr/bin/env python3
"""
IQ Option OTC Signals Bot - Final Fixed Version (Render Ready)
- Lightweight (no pandas_ta / numba)
- All indicators calculated with pure pandas
- Proper JobQueue + Event Loop fix for Render
- Auto signals every 3 minutes
- Martingale + Win rate tracking
...
def format_signal(sig, user_id):
    ...
    return (
        f"🎯 **HIGH-PROB OTC SIGNAL** (Final Fixed)\n\n"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"🚀 **IQ Option OTC Signals Bot** (Final Fixed Version)\n\n"
...
def main():
    ...
    # Proper JobQueue initialization
    job_queue = JobQueue()
    ...
    print("✅ OTC Signals Bot is running successfully!")
    app.run_polling()
